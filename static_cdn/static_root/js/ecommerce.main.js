$(document).ready(function () {
    var stripFormModule = $(".strip-payment-form");
    var stripeModuleToken = stripFormModule.attr("data-token")
    var stripeModuleTokenUrl = stripFormModule.attr("data-next-url")
    var stripeModuleBtmTitle = stripFormModule.attr("data-btn-title") || "Add card"
    var stripeTemplate = $.templates("#stripeTemplate");
    var stripeTemplateDataContext = {
        publishKey: stripeModuleToken,
        nextUrl: stripeModuleTokenUrl,
        btnTitle: stripeModuleBtmTitle
    };
    var stripeTemplateHtml = stripeTemplate.render(stripeTemplateDataContext);
    stripFormModule.html(stripeTemplateHtml);

    // https secure site when line
    var paymentForm = $(".payment-form");

    if (paymentForm.length > 1) {
        alert("Only One palyment Form Allowed");
        ...
        //     var errorClasses = "btn btn-denger disabled my-3"
        ...
        function displayBtnStatus(element, newHtml, newClasses, loadTime, timeout){
            ...
            element.removeClass(element.addClass(defaultClasses))
